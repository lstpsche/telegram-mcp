ALTER TABLE text_grants ADD COLUMN documents INTEGER NOT NULL DEFAULT 0 CHECK (documents IN (0, 1));
...
CREATE TABLE text_audit (
    ...
    operation TEXT NOT NULL CHECK (operation IN ('list_chats', 'list_messages', 'get_message_context', 'search_messages', 'list_unread', 'list_scopes', 'open_image', 'open_document', 'catch_up')),
