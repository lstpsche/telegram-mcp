ALTER TABLE text_grants ADD COLUMN images INTEGER NOT NULL DEFAULT 0 CHECK (images IN (0, 1));
...
CREATE TABLE text_audit (
    ...
    operation TEXT NOT NULL CHECK (operation IN ('list_chats', 'list_messages', 'get_message_context', 'search_messages', 'list_unread', 'list_scopes', 'open_image')),
