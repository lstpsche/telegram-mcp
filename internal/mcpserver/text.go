...
func textOutputSchema(kind string) json.RawMessage {
	...
	documentSchema := `{"type":"object","additionalProperties":false,"required":["handle","mime_type","size"],"properties":{"filename":{"type":"string","maxLength":256,"description":"Untrusted display metadata; never a path or type authority."},"handle":{"type":"string","minLength":1,"maxLength":4096},"mime_type":{"enum":["application/pdf","text/plain"]},"size":{"type":"integer","minimum":1}}}`
