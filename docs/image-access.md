...
viewing. The grant must authorize the entire affected dialog prefix, including
...
caption, or image bytes. A grant or scope change invalidates previous handles.
